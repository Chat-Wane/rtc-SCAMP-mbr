...
Peer.prototype.receive = function(link, message){
	...
	this.send(new MOfferRequest(pair._e,pair._c,
				    this.partialView.length()+1), link);
	break;
    case "MOfferResponse":
	...
	break;
    case "MOfferRequest":
	console.log("received "+message.type+"; k = "+message.k);
        var offers = this.generateOffers(message.k, "subscription");
	var self = this;
	setTimeout(function(){
